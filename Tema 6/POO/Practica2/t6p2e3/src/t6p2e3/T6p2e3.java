...
//        tercera empresa
        ...
        listaEmpresas[2].setListaEmpleados(getListaEmpleados2());
       ...
       public static void añadirEmpleados (Empresa empresa){
        ...
        lista.add(new Cliente("al.1",21,"111"));
        lista.add(new Cliente("al.2",31,"411"));
        return lista;
    }
     public static ArrayList<Empleado> getListaEmpleados2(){
